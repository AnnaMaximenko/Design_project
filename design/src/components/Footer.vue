<template>
  <footer class="footer center">
    <div class="footer-left footer__item">
      <div class="footer-left__logo">
        ...
        <h3 class="footer-left__textual">Interno</h3>
      </div>
    ...
    <div class="footer-right footer__item">
      ...
      <p class="footer-right__contact">
        55 East Birchwood Ave.<br />Brooklyn, New York 11201
      </p>
      <a href="#" class="footer-right__contact">contact@interno.com</a>
      <a href="#" class="footer-right__contact">(123) 456 - 7890</a>
    </div>
  </footer>
</template>
